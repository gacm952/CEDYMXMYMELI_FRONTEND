    ...
    <>
            ...
            <div className="">  
                <div className='grid grid-cols-9 mb-1 rounded gap-10 p-2 border border-gray-500'>
                  ...
                  {!isActive && (
                    <button 
                    className="px-7 gap-4"
                    onClick={openModal6}
                    >
                      <div className="grid items-center text-center group border rounded-lg border-gray-500 px-2 py-2 hover:border-red-700 hover:bg-red-700">
                      <svg
                        viewBox="0 0 320 512"
                        fill="red"
                        className="h-4 w-4 group-hover:fill-white"
