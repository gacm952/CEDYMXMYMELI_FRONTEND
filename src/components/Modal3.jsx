              ...
              <div className="mb-4 rounded-full border border-gray-300 flex items-center justify-center w-12 h-12 flex-shrink-0 mx-auto">
                ...
                <div className="md:flex items-center">
                  ...
                  <div className="mt-4 md:mt-0 text-center md:text-left">
                      <h2 className="text-xl font-bold">Este usuario no asistió a su cita anterior</h2>
                      <p className="text-sm text-center text-gray-700 mt-1"> ¿Estas seguro que deseas agendarle una nueva cita?
                        </p>
                  </div>
                  </div>
