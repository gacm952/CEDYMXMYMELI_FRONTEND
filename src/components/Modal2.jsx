const Modal2 = ({ isOpen, onClose, handleUpdateResponsable }) => {
              ...
              <div className="mb-4 rounded-full border border-gray-300 flex items-center justify-center w-12 h-12 flex-shrink-0 mx-auto">
                ...
                <div className="md:flex items-center">
                  ...
                  <div className="flex gap-4 mt-4 md:mt-0 text-center md:text-left">
                      <h2 className="text-xl font-bold">¿Deseas hacer cierre del día?</h2>
                  </div>
                  </div>
                ...
                <div className="text-center md:text-right mt-4 md:flex md:justify-center">
                  ...
                  > No </button>
                  <button onClick={handleUpdateResponsable} className="block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-gray-200 rounded-lg font-semibold text-sm mt-4
                      md:mt-0 md:order-1">Si</button>
                  </div>
              </div>
            </div>
          </div>
